export function SideBar() {
    return <><div id="hs-sidebar-content-push" className="hs-overlay [--body-scroll:true] lg:[--overlay-backdrop:false] [--is-layout-affect:true] [--opened:lg] [--auto-close:lg] hs-overlay-open:translate-x-0 lg:hs-overlay-layout-open:translate-x-0 lg:block lg:-translate-x-full lg:end-auto lg:bottom-0 w-64 [--body-scroll:true]
...
<div className="sm:hs-overlay-layout-open:ms-64 min-h-160 bg-white transition-all duration-300 dark:bg-neutral-800">
